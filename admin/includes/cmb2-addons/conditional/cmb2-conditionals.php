 ...
 */
if (!class_exists('XLWCFG_CMB2_Conditionals')) {

    /**
     * CMB2_Conditionals Plugin.
     */
    class XLWCFG_CMB2_Conditionals {
        ...
        public function admin_footer() {
            ...
            if (XLWCFG_Common::xlwcfg_valid_admin_pages()) {
                wp_enqueue_script('xlwcfg-cmb2-conditionals', plugins_url('/cmb2-conditionals.js', __FILE__), array('jquery', 'cmb2-scripts'), self::VERSION, true);
            }
        }
...
//				);
    ...
    if (( function_exists('wp_installing') && wp_installing() === false ) || (!function_exists('wp_installing') && (!defined('WP_INSTALLING') || WP_INSTALLING === false ) )) {
        add_action('plugins_loaded', 'xlwcfgcmb2_conditionals_init');
    }

    if (!function_exists('xlwcfgcmb2_conditionals_init')) {

        /**
         * Initialize the class.
         */
        function xlwcfgcmb2_conditionals_init() {
            $cmb2_conditionals = new XLWCFG_CMB2_Conditionals();
        }
