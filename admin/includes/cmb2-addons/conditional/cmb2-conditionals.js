jQuery(document).ready(function ($) {
     ...
     */
    window.XLWCFGCMB2ConditionalsInit = function (changeContext, conditionContext) {
        ...
        changeContext.on('change', 'input, textarea, select', function (evt) {
            ...
            dependants = XLWCFGCMB2ConditionalsFindDependants(fieldName, elm, conditionContext);
            ...
            if (dependants.length > 0) {
                ...
                if ('checkbox' === elm.attr('type')) {
                    ...
                    elmValue = XLWCFGCMB2ConditionalsStringToUnicode(evt.currentTarget.value);
                }
                ;
                ...
                dependants.each(function (i, e) {
                    ...
                    if ('undefined' !== typeof currentFieldName && '' !== currentFieldName && $.inArray(currentFieldName, dependantsSeen) < 0) {
                        ...
                        if (false === shouldShow) {
                            XLWCFGCMB2ConditionalsRecursivelyHideDependants(currentFieldName, current, conditionContext);
                        }
                    ...
                    changeContext.trigger("xlwcfg_conditional_runs", [current, currentFieldName, requiredValue, currentParent, shouldShow, elm, elmValue]);
        ...
        //     if ($(this).hasClass("xlwcfg_custom_wrapper_group")) {
        //         return;
        //     }
        ...
        $('[data-conditional-id]', conditionContext).not(".xlwcfg_custom_wrapper_group").parents('.cmb-row:first').hide({
            "complete": function () {
                $("body").trigger("xlwcfg_trigger_conditional_on_load");
     ...
     */
    function XLWCFGCMB2ConditionalsFindDependants(fieldName, elm, context) {
     ...
     */
    function XLWCFGCMB2ConditionalsRecursivelyHideDependants(fieldName, elm, context) {
        var dependants = XLWCFGCMB2ConditionalsFindDependants(fieldName, elm, context);
        ...
        if (dependants.length > 0) {
            dependants.each(function (i, e) {
                ...
                XLWCFGCMB2ConditionalsRecursivelyHideDependants(dependantName, dependant, context);
            });
        }
    }


    function XLWCFGCMB2ConditionalsStringToUnicode(string) {
        var i, result = '',
