...
$non_sensitive_page_link = esc_url( "https://xlplugins.com/non-sensitive-usage-tracking/?utm_source=bonanza-lite&utm_campaign=optin&utm_medium=text-click&utm_term=non-sensitive" );
...
<div id="xlo-wrap" class="wrap">
    <div class="xlo-logos">
        <img class="xlo-plugin-icon" width="80" height="80" src="<?php echo plugin_dir_url( XLWCFG_PLUGIN_FILE ) . 'admin/assets/img/wc.png'; ?>"/>
        <i class="dashicons dashicons-plus xlo-first"></i>
        <img class="xlo-wrap-logo" width="80" height="80" src="<?php echo plugin_dir_url( XLWCFG_PLUGIN_FILE ) . 'admin/assets/img/xlplugins.png'; ?>"/>
    </div>
    <div class="xlo-content">
        <p><?php echo $user_instance ?><br></p>
        <h2>Thank you for choosing Bonanza!</h2>
    ...
    <div class="xlo-actions" data-source="Bonanza">
