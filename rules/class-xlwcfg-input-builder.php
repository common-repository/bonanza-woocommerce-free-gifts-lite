...
class xlwcfg_Input_Builder {
	...
	public static function create_input_field( $field_args, $value = null ) {
		...
		$field_args   = apply_filters( 'xlwcfg_rules_get_input_defaults', self::get_input_field_defaults( $field_args ) );
		$field_value  = apply_filters( 'xlwcfg_rules_get_input_value', $value, $field_args );
		$input_object = XLWCFG_Core()->rules->woocommerce_xlwcfg_rule_get_input_object( $field_args['input'] );
